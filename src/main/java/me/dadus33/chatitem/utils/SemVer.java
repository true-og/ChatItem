...
/**
 * Represents the simplified SemVer schema Negativity uses for its plugin
 * versions.
 */
public final class SemVer implements Comparable<SemVer> {
    ...
    /**
     * Slightly different from {@link #equals} in that this method will return true
     * if the suffix has the same {@link Suffix#getWeight() weight} but not the same
     * {@link Suffix#getText()} text
     */
    ...
    public boolean equals(Object o) {
        ...
        return major == semVer.major && minor == semVer.minor && patch == semVer.patch
                && Objects.equals(suffix, semVer.suffix);
    ...
    public static @Nullable SemVer parse(String text) {
