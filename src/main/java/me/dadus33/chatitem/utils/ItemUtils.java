...
public class ItemUtils {
    ...
    // colored items
    public static final Material BROWN_STAINED_GLASS_PANE = getMaterialWithCompatibility("BROWN_STAINED_GLASS_PANE",
            "STAINED_GLASS_PANE");
    public static final Material GRAY_STAINED_GLASS_PANE = getMaterialWithCompatibility("GRAY_STAINED_GLASS_PANE",
            "STAINED_GLASS_PANE");
    public static final Material WHITE_STAINED_GLASS = getMaterialWithCompatibility("WHITE_STAINED_GLASS_PANE",
            "STAINED_GLASS_PANE");
