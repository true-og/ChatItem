...
public class PacketUtils {
    ...
    static {
        ...
        NMS_PREFIX = Version.getVersion().isNewerOrEquals(Version.V1_17) || IS_THERMOS ? "net.minecraft."
                : "net.minecraft.server." + (version == "" ? "" : version + ".");
    ...
    public static Object getPlayerConnection(Player p) {
        ...
        try {
            ...
            return ReflectionUtils.getFirstWith(entityPlayer, entityPlayer.getClass(),
                    getNmsClass(Version.getVersion().isNewerOrEquals(Version.V1_21_11) ? "ServerGamePacketListenerImpl"
            ...
            if (sendPacketMethod == null) {
                ...
                if (v.isNewerOrEquals(Version.V1_20)) {
                    ...
                    if (packetSrvClass != null)
                        sendPacketMethod = packetSrvClass.getDeclaredMethod("b",
                                getNmsClass("Packet", "network.protocol."));

                }

                if (sendPacketMethod == null)
                    sendPacketMethod = playerConnection.getClass().getMethod(
                            Version.getVersion().isNewerOrEquals(Version.V1_18) ? "a" : "sendPacket",
                            getNmsClass("Packet", "network.protocol."));
