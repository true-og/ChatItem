        ...
        pipe.addFirst(new ChannelInitializer<Channel>() {
            ...
            protected void initChannel(Channel channel) {
                ...
                try {
                    ...
                    channel.eventLoop().submit(() -> {
                        ...
                        try {
                            ...
                            if (interceptor == null) {
                                ...
                                channel.pipeline().addBefore("packet_handler", ChannelAbstract.KEY_HANDSHAKE,
                                        interceptor);
                    ...
                    packetManager.getPlugin().getLogger().log(Level.SEVERE, "Cannot inject incoming channel " + channel,
                            e);
        ...
        public void channelRead(ChannelHandlerContext ctx, Object packet) {
            ...
            try {
                ...
                if (packetType != null && packetType == PacketType.Handshake.IS_SET_PROTOCOL) {
                    ...
                    if (possibleProtocol == -1 || possibleProtocol == 255 || possibleProtocol == Bukkit.getPort())
