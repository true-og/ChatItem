...
public interface PacketType {
    ...
    static PacketType getPacketTypeFor(String packetName, PacketType[] types, PacketType unset) {
        ...
        for (PacketType packet : types)
            if (packet.getFullName().equalsIgnoreCase(packetName) || packet.getPacketName().equalsIgnoreCase(packetName)
                    || packet.getAlias().contains(packetName))
                return packet;
        return unset;
    ...
    public static enum Server implements PacketType {
        ...
        CHAT("Chat", "ClientboundPlayerChatPacket", "ClientboundSystemChatPacket"), UNSET("Unset");
    ...
    public static enum Handshake implements PacketType {
        ...
        IS_SET_PROTOCOL("InSetProtocol"), UNSET("Unset");
