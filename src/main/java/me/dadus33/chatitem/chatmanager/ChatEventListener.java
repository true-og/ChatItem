...
public class ChatEventListener implements Listener {
    ...
    public void onChat(AsyncPlayerChatEvent e) {
        ...
        e.setMessage(s.replace(Character.toString(ChatManager.SEPARATOR),
                SEPARATOR + Integer.toString(c.getId()) + SEPARATOR_END));
        e.setFormat(e.getFormat().replace(oldMsg, e.getMessage())); // set own message for plugin that already put the
