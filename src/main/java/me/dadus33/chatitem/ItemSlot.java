...
public enum ItemSlot {
    ...
    HAND("", false), HELMET("helmet", false), CHESTPLATE("chestplate", false), LEGGINGS("leggings", false),
    BOOTS("boots", false), INVENTORY("inventory", true), ENDERCHEST("enderchest", true);
    ...
    public List<String> getPlaceholders() {
        ...
        return ChatItem.getInstance().getConfig()
                .getStringList(isBasic() ? "general.placeholders" : "general.other-placeholders." + key + ".keys");

    }

    public boolean isEnabled() {

        return isBasic() || ChatItem.getInstance().getConfig()
                .getBoolean("general.other-placeholders." + key + ".enabled", true);
    ...
    public boolean isDenyIfNoItem() {
        ...
        return ChatItem.getInstance().getConfig()
                .getBoolean("general" + (isBasic() ? "" : ".other-placeholders." + key) + ".deny-if-no-item", true);

    }

    public String getShowMessage() {

        return Colors.color(ChatItem.getInstance().getConfig()
                .getString("general" + (isBasic() ? "" : ".other-placeholders." + key) + ".show", ""));
